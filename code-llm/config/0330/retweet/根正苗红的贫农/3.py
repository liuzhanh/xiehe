...
# 加载真实用户数据
real_data_path = '/home/LH/code-llm/config/0330/retweet/根正苗红的贫农/2-user_info_with_exist_test.xlsx'
real_data_df = pd.read_excel(real_data_path)

# 将生成的虚拟数据保存到新文件路径
generated_data_path = '/home/LH/code-llm/config/0330/retweet/根正苗红的贫农/3-user_info_with_exist_json.xlsx'
templete = {
    "age": 30,
