...
# Read the repo_4913244580089675_network.json file
with open(r'repo_4913244580089675_network.json', 'r', encoding='utf-8') as f:
    network = json.load(f)
...
with open(r'Combined_Personas_662_new.json', 'w', encoding='utf-8') as f:
